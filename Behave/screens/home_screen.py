...
class HomeScreen(CommondActions):
    def __init__(self, context):
        ...
        self.img_bike = (By.XPATH, "(//android.view.ViewGroup[@content-desc='store item'])[2]/android.view.ViewGroup["
                                   "1]/android.widget.ImageView")
        self.lbl_Bike = (By.ANDROID_UIAUTOMATOR, '.text("Sauce Labs Bike Light")')
